                ...
                (async() => {
                    ...
                    await cluster.task(async({ page, data: url }) => {
                        ...
                        try {
                            ...
                            await page.waitForSelector('#mantine-R3bm-body > div > div.mantine-Container-root.mantine-bpygq5 > div > div.mantine-1avyp1d > div > figure > div > img', { timeout: 60000 }).then(() => {});
